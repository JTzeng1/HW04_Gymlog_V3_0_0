...
public class MainActivity extends AppCompatActivity {
    ...
    static final String SAVED_INSTANCE_STATE_USER_KEY = "com.example.hw04_gymlog_v300.SAVED_INSTANCE_STATE_USERID_KEY";
    ...
    static final String SAVED_INSTANCE_STATE_USER_KEY = "com.example.hw04_gymlog_v300.SAVED_INSTANCE_STATE_USER_KEY";

    private static final int LOGGED_OUT = -1;
    ActivityMainBinding binding;
    private GymLogRepository repository;
    private GymLogViewModel gymLogViewModel;
    public static final String TAG = "AMM_GYMLOG";
...
//        });
    ...
    private void loginUser(Bundle savedInstanceState) {
        ...
        //check intent for logged in user id
    ...
    protected void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putInt(SAVED_INSTANCE_STATE_USER_KEY, loggedInUserId);
        updateSharedPreference();
    }
    ...
    private void getInformationFromDisplay() {
        ...
        try {
            mWeight = Double.parseDouble(binding.weightInputEditView.getText().toString());
        } catch (NumberFormatException e) {
            Log.d(TAG, "Error reading value from, Weight edit text.");
        }

        try {
            mReps = Integer.parseInt(binding.repInputEditView.getText().toString());
        } catch (NumberFormatException e) {
...
=======
        ...
        // user is not logged in a this point. go to login screen
        if(loggedInUserId == -1){
            Intent intent = LoginActivity.loginIntentFactory(getApplicationContext());
            startActivity(intent);
        }
